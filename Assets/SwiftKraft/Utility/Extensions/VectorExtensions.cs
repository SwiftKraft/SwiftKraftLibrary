...
namespace SwiftKraft.Utils
{
    public static class VectorExtensions
    {
        ...
        public static bool InRange(this Vector2 pos, Vector2 target, float range) => (pos - target).sqrMagnitude < range * range;
        public static bool InRange(this Vector3 pos, Vector3 target, float range) => (pos - target).sqrMagnitude < range * range;
        public static bool InRange(this Vector4 pos, Vector4 target, float range) => (pos - target).sqrMagnitude < range * range;
    }
}
